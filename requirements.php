...
$requirements = array(
    ...
    array (
        ...
        "result"=>("" === $email_func = checkPhpFunctions(["stream_socket_client", "socket_set_timeout", "stream_socket_enable_crypto", "socket_get_status", "fsockopen"])),
...
<head>
    ...
    <title>Website Review | Requirements</title>
    <style type="text/css">
        body
        {
            background: white;
...
<div id="page">
    ...
    <div id="content">
        ...
        <p>
            ...
            for running <a href="http://website-review.php8developer.com">Website Review</a>.
